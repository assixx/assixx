  ...
  for (const file of htmlFiles) {
    ...
    try {
      ...
      if (oldUserInfoPattern.test(content)) {
        content = content.replace(oldUserInfoPattern, `<div id="user-info">
      ...
      const logoutBtnPattern = /id="logout-btn"[^>]*>(?!.*<i.*fa-sign-out-alt)/g;
      ...
      if (content.includes('checkAuth()') && !content.includes('loadUserInfo')) {
