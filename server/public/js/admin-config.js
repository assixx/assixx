document.addEventListener('DOMContentLoaded', () => {
    ...
    tabButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Logs laden
            const days = tabId === 'logs-3days' ? 3 : 
                         tabId === 'logs-10days' ? 10 : 
                         tabId === 'logs-30days' ? 30 : 0; // 0 für "alle"
    ...
    function displayAdminLogs(logs, days) {
        const tableId = days === 3 ? 'logs-3days-body' : 
                       days === 10 ? 'logs-10days-body' : 
                       days === 30 ? 'logs-30days-body' : 'logs-all-body';
