...
export async function showConfirm(message: string): Promise<boolean> {
  ...
  return await new Promise((resolve) => {
    ...
    const confirmBtn = confirmDiv.querySelector(
      '.confirm-modal__btn--confirm',
    ) as HTMLButtonElement | null;
    const cancelBtn = confirmDiv.querySelector(
...
export async function showConfirmDanger(
  ...
  return await new Promise((resolve) => {
    ...
    const dangerBtn = modalDiv.querySelector(
...
export async function showConfirmWarning(
  ...
  return await new Promise((resolve) => {
    ...
    const confirmBtn = modalDiv.querySelector(
      '.confirm-modal__btn--confirm',
    ) as HTMLButtonElement | null;
    const cancelBtn = modalDiv.querySelector(
      '.confirm-modal__btn--cancel',
...
export async function showInfoModal(message: string, title: string = 'Hinweis'): Promise<void> {
  ...
  await new Promise<void>((resolve) => {
    ...
    const okBtn = modalDiv.querySelector(
      '.confirm-modal__btn--confirm',
    ) as HTMLButtonElement | null;
