<!--
  EditAssetAvailabilityModal.svelte (Shared)
  Modal for editing existing asset availability entries.
...
<script lang="ts">
  ...
  const log = createLogger('EditAssetAvailabilityModal');
  ...
  let editStatus = $state<AssetAvailabilityStatus>('operational');
  ...
  $effect(() => {
    if (entry !== null && show) {
      editStatus = entry.status as AssetAvailabilityStatus;
  ...
  async function handleSave(): Promise<void> {
    ...
    try {
      ...
      log.error({ err }, 'Error updating asset availability entry');
    } finally {
      submitting = false;
    }
  }
...
{#if show && entry !== null}
  ...
  <div
    id="edit-asset-availability-modal"
    class="modal-overlay modal-overlay--active"
    role="dialog"
    aria-modal="true"
    aria-labelledby="edit-asset-avail-modal-title"
    tabindex="-1"
    onclick={(e) => {
    ...
    >
      <div class="ds-modal__header">
        <h3
          ...
          id="edit-asset-avail-modal-title"
        >
      ...
      <div class="ds-modal__body">
        ...
        <div class="form-field">
          <label
            ...
            for="edit-asset-status-dropdown">Status</label
          >
          <div
            class="dropdown"
            id="edit-asset-status-dropdown"
          >
        ...
        <div class="form-field">
          <label
            class="form-field__label"
            for="edit-asset-start-date">Von Datum</label
          >
          <AppDatePicker
        ...
        <div class="form-field">
          <label
            class="form-field__label"
            for="edit-asset-end-date">Bis Datum</label
          >
          <AppDatePicker
        ...
        <div class="form-field">
          <label
            class="form-field__label"
            for="edit-asset-reason">Grund (optional)</label
          >
          <input
            type="text"
            id="edit-asset-reason"
        ...
        <div class="form-field">
          <label
            class="form-field__label"
            for="edit-asset-notes">Notiz (optional)</label
          >
          <textarea
            id="edit-asset-notes"
            class="form-field__control"
