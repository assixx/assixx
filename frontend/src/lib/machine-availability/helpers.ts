...
// =============================================================================
// Used by machine availability history pages
...
/**
 * Get human-readable text for machine availability status
 */
...
/**
 * Get CSS badge class for machine availability status
 */
...
/**
 * Get Font Awesome icon class for machine availability status
 */
