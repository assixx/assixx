<!--
  DeleteConfirmationModal.svelte (Shared - Machine Availability)
  Modal for confirming deletion of machine availability entries.
...
{#if show && entry !== null}
  <div
    ...
    role="dialog"
    aria-modal="true"
    aria-labelledby="delete-machine-avail-modal-title"
    tabindex="-1"
    onclick={(e) => {
    ...
    >
      <div class="ds-modal__header">
        <h3
          ...
          id="delete-machine-avail-modal-title"
        >
      ...
      <div class="ds-modal__body">
        <p class="text-(--color-text-secondary)">
          Möchten Sie diesen Maschinenverfügbarkeitseintrag wirklich löschen?
        </p>
