...
/**
 * Admin Profile Management - Forms Layer
...
function handlePasswordChangeError(error: unknown): void {
  console.error('[AdminProfile] Password change error:', error);
  ...
  pictureInput.addEventListener('change', (e) => {
    ...
    void (async () => {
      try {
        ...
        console.error('[AdminProfile] Error uploading profile picture:', error);
  ...
  removePictureBtn.addEventListener('click', () => {
    void (async () => {
      ...
      try {
        ...
        console.error('[AdminProfile] Error removing profile picture:', error);
