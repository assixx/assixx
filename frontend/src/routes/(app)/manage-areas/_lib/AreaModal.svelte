  ...
  >
    ...
    >
      ...
      <div class="ds-modal__body">
        ...
        <!-- Description -->
        <div class="form-field">
          <label class="form-field__label" for="area-description"
        ...
        <!-- Area Lead Dropdown -->
        <div class="form-field">
          <label class="form-field__label" for="area-lead-hidden">
            <i class="fas fa-user-tie mr-1"></i>
            {MESSAGES.LABEL_AREA_LEAD}
          </label>
          <input type="hidden" id="area-lead-hidden" value={formAreaLeadId ?? ''} />
        ...
        <!-- Type Dropdown -->
        <div class="form-field">
          <label class="form-field__label" for="area-type-hidden">
            {MESSAGES.LABEL_TYPE} <span class="text-red-500">*</span>
          </label>
          <input type="hidden" id="area-type-hidden" value={formType} />
        ...
        {#if isEditMode}
          <div class="form-field">
            <label class="form-field__label" for="area-status-hidden">
              {MESSAGES.LABEL_STATUS} <span class="text-red-500">*</span>
            </label>
            <input type="hidden" id="area-status-hidden" value={formIsActive} />
