<script lang="ts">
  ...
  import { updateEscalation as apiUpdateEscalation, logApiError } from '../../_admin/api';
  import { MESSAGES } from '../../_admin/constants';

  import type { TpmEscalationConfig } from '../../_admin/types';
