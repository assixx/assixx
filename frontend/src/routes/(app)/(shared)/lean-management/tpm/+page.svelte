<script lang="ts">
  ...
  import { tpmState } from './_admin/state.svelte';

  import type { PageData } from './$types';
  import type { TpmPlan, PlanStatusFilter } from './_admin/types';
      ...
      <div class="card">
        ...
        <div class="card__body">
          <PlanOverview
            ...
            ondelete={canDelete ? handleDeleteRequest : (
              () => {
                /* noop — no delete permission */
              }
            )}
