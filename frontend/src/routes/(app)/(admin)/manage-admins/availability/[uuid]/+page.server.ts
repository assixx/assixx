/**
 * Availability History - Server-Side Data Loading (Admin)
 * @module manage-admins/availability/[uuid]/+page.server
 */
...
const log = createLogger('AdminAvailabilityHistory');
...
export const load: PageServerLoad = async ({ cookies, fetch, params, url }) => {
  ...
  try {
    ...
    log.info(
      ...
      'Admin availability history loaded',
    );
