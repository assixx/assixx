...
export type FeatureCategory = 'basic' | 'communication' | 'productivity' | 'management' | 'analytics';

// Status types
export type DocumentCategory = 'general' | 'hr' | 'finance' | 'technical' | 'legal' | 'other';
export type KvpStatus = 'pending' | 'in_review' | 'approved' | 'rejected' | 'implemented';
