...
const BaseSchema = z.object({
  ...
  requestNote: z.string().trim().max(1000, 'Request note cannot exceed 1000 characters').nullish(),
});
...
export class UpdateVacationRequestDto extends createZodDto(UpdateVacationRequestSchema) {}
