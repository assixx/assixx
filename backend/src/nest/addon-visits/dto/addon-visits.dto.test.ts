...
describe('MarkVisitedSchema', () => {
  it('should accept valid addon', () => {
    expect(MarkVisitedSchema.safeParse({ addon: 'calendar' }).success).toBe(true);
    expect(MarkVisitedSchema.safeParse({ addon: 'kvp' }).success).toBe(true);
    expect(MarkVisitedSchema.safeParse({ addon: 'surveys' }).success).toBe(true);
  });
  ...
  it('should reject invalid addon value', () => {
    expect(MarkVisitedSchema.safeParse({ addon: 'blackboard' }).success).toBe(false);
  });
});
