...
export const SetPlanAssignmentsSchema = z.object({
  userIds: z
    ...
    .max(50, 'Maximal 50 Mitarbeiter pro Zuweisung'),
  scheduledDate: z
    .string()
    .regex(DATE_REGEX, 'Datum muss im Format YYYY-MM-DD sein'),
});

export class SetPlanAssignmentsDto extends createZodDto(
