/**
 * Unit tests for TenantDeletionExecutor (NestJS migration)
 *
 * Migrated from services/tenant-deletion-executor.service.test.ts.
 * Key change: PoolClient returns { rowCount, rows } instead of ResultSetHeader.
 * Logger mocking removed — NestJS Logger is internal to the class.
 */
...
describe('TenantDeletionExecutor', () => {
  ...
  /** Helper to create a mock pg QueryResult */
  function mockResult(rowCount: number) {
