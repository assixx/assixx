...
export interface TenantInfoRow extends RowDataPacket {
  id: number;
  company_name: string;
  subdomain: string;
  tax_id?: string;
...
export interface LegalHoldResult extends RowDataPacket {
  reason: string;
  active: number;
}
...
export interface LegalHoldRow extends RowDataPacket {
  id: number;
  tenant_id: number;
  reason?: string;
  active: number;
 ...
 */
export interface DeletionWarningUser extends RowDataPacket {
  email: string;
