...
describe("Survey API Endpoints", () => {
  ...
  describe("POST /api/surveys", () => {
    ...
    it("should create survey for admin", async () => {
      ...
      const surveys = asTestRows<any>(rows);
      ...
      const questions = asTestRows<any>(rows);
  ...
  describe("GET /api/surveys/:id", () => {
    ...
    beforeEach(async () => {
      ...
      const surveyResult = asTestRows<any>(rows);
    ...
    it("should include user response if exists", async () => {
      ...
      const responseResult = asTestRows<any>(rows);
  ...
  describe("POST /api/surveys/:id/responses", () => {
    ...
    it("should submit survey response", async () => {
      ...
      const responses = asTestRows<any>(rows);
      ...
      const answers = asTestRows<any>(rows);
    ...
    it("should handle anonymous surveys", async () => {
      ...
      const anonResult = asTestRows<any>(rows);
      ...
      const qResult = asTestRows<any>(rows);
    ...
    it("should enforce survey dates", async () => {
      ...
      const expiredResult = asTestRows<any>(rows);
  ...
  describe("GET /api/surveys/:id/results", () => {
    ...
    it("should include text responses", async () => {
      ...
      const textQ = asTestRows<any>(rows);
