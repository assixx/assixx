  ...
  try {
    ...
    if (tenantId !== userTenantId && req.user.role !== 'root' && req.user.role !== 'admin') {
      res
        ...
        .json(errorResponse(ACCESS_DENIED_MESSAGE, HTTP_STATUS_FORBIDDEN));
      return;
    }
...
export async function getMyFeatures(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
...
export async function getTenantFeaturesSummary(
  req: AuthenticatedRequest,
  res: Response,
): Promise<void> {
  try {
...
export async function activateFeature(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
...
export async function deactivateFeature(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
...
export async function testFeatureAccess(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    ...
    if (!hasAccess) {
      res
        .status(HTTP_STATUS_FORBIDDEN)
        .json(errorResponse('Feature access denied', HTTP_STATUS_FORBIDDEN));
      return;
    }
...
export async function getAllTenantsWithFeatures(
  req: AuthenticatedRequest,
  res: Response,
): Promise<void> {
  try {
