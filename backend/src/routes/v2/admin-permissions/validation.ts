...
export const setPermissionsValidation: ValidationChain[] = [
  ...
  body("permissions.canRead")
    .optional()
    .isBoolean()
    .withMessage("canRead must be a boolean"),
  body("permissions.canWrite")
    .optional()
    .isBoolean()
    .withMessage("canWrite must be a boolean"),
...
export const bulkPermissionsValidation: ValidationChain[] = [
  body("adminIds")
    .isArray({ min: 1 })
    .withMessage("Admin IDs must be a non-empty array"),
  body("adminIds.*")
    .isInt({ min: 1 })
    .withMessage("Each admin ID must be a positive integer"),
