...
router.get('/attachments/:filename', authenticateToken, chatController.getAttachment);
router.put('/messages/:id/read', authenticateToken, chatController.markAsRead);
router.get('/work-schedules', authenticateToken, chatController.getWorkSchedules);
...
router.put('/messages/:id/archive', authenticateToken, chatController.archiveMessage);
