...
describe('Tenant Deletion Integration Tests', () => {
  ...
  describe('DELETE /api/root/tenants/:id', () => {
    ...
    it('should send warning email to admins', async () => {
      ...
      await query('INSERT INTO users (tenant_id, username, email, role) VALUES (?, ?, ?, ?)', [
        testTenantId,
        'test-admin',
        'admin@test-deletion.com',
        'admin',
      ]);
  ...
  describe('Complete Deletion Flow', () => {
    it('should process deletion after grace period', async () => {
      // Create test data
      await query('INSERT INTO documents (tenant_id, filename, uploaded_by) VALUES (?, ?, ?)', [
        testTenantId,
        'test.pdf',
        testUserId,
      ]);
  ...
  describe('Error Recovery', () => {
    ...
    it('should handle partial deletion failures', async () => {
      ...
      jest.spyOn(tenantDeletionService as any, 'executeStep').mockImplementationOnce((step) => {
