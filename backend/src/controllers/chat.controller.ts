...
class ChatController {
  ...
  async getUsers(req: Request, res: Response): Promise<void> {
    try {
      ...
      const users = await chatService.getUsers(req.user.tenant_id, req.user.userId);
      res.json(users);
    } catch (error: unknown) {
  ...
  async getConversations(req: Request, res: Response): Promise<void> {
    try {
      ...
      const conversations = await chatService.getConversations(req.user.tenant_id, req.user.userId);
  ...
  async getMessages(req: Request, res: Response): Promise<void> {
    try {
      ...
      const offset = Number.parseInt(typeof req.query.offset === 'string' ? req.query.offset : '0');
  ...
  async addParticipant(req: Request, res: Response): Promise<void> {
    try {
      ...
      await chatService.addParticipant(conversationId, userId, req.user.userId, req.user.tenant_id);
