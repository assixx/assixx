...
async function connectToMySQL(user, password) {
  try {
    ...
    if (assixxExists) {
      ...
      console.info('To create it, run these commands in the MySQL command line:');
...
function updateEnvFile(user, password) {
  try {
    ...
    console.info('✅ .env file updated successfully with your MySQL credentials.');
  } catch (error) {
...
console.info('====================');
console.info('This script will help you test your MySQL connection and update your .env file.');
promptUser();
