...
| `features`              | id (SERIAL PK), code (UNIQUE), name, category (ENUM: basic/core/premium/enterprise)                                                                                                       | Feature-Flags (global, kein RLS)                                               |
| `tenant_features`       | tenant_id, feature_id                                                                                                                                                                     | Welcher Tenant hat welche Features aktiv                                       |
