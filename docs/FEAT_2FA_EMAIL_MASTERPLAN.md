...
> **Plan type:** FEATURE
> **Created:** 2026-04-26
> **Version:** 0.6.5 (**Phase 3 DONE** — Session 9 unit-test fan-out shipped: TwoFactorAuthService orchestration + AuthService new branches + SignupService 2FA branch + Reaper service + EmailChangeService)
> **Status:** ACCEPTED — Phase 1 DONE (2026-04-28); **Phase 2 DONE** (2026-04-28 / 2026-04-29); **Phase 3 DONE** (2026-04-29): Sessions 8 + 9a + 9 — full unit-test layer for the 2FA stack landed (113 cumulative new unit tests). Ready for **Phase 4** (API integration tests, signup-cleanup E2E, reaper E2E, email-change Hijack-Sim/Tippfehler-Sim/Bombing-Sim — Session 10). Cutover-Apparat (Bestandsuser-Vorabmail, Sender-Warmup, T-Day-Timeline) per Greenfield-Status entfallen — siehe CLAUDE.md Zeile 15 + ADR-050 §"Deployment Context: Greenfield Launch"
...
> **Actual sessions:** 9 / 12 (Phase 0.5.3 + 0.5.5 + Phase 1 + Phase 2 Steps 2.1 + 2.2 + 2.3 + 2.4 + 2.5 + 2.6 + 2.7 + 2.8 + 2.9 + 2.10 + 2.11 + 2.12 + R13 load-test wiring + Phase 3 Sessions 8 + 9 erledigt)
...
| 10      | 4     | API integration tests + email-capture + reaper end-to-end + **Email-Change end-to-end (Step 2.12: Hijack-Sim, Tippfehler-Sim, Bombing-Sim)**                                                                                                                            | PENDING                              |            |
