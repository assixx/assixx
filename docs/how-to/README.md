...
| [HOW-TO-DEV-SMTP](./HOW-TO-DEV-SMTP.md)                         | Mailpit als Dev-SMTP-Capture — Setup, Doppler-Secrets, Smoke-Test, Reset, Troubleshooting (FEAT_2FA_EMAIL §0.5.5; replaces Maildev 2026-04-29)   |
| [HOW-TO-2FA-RECOVERY](./HOW-TO-2FA-RECOVERY.md)                 | 2FA-Recovery (ADR-054 / DD-30): Lost-Mailbox-Pfad · Lockout-Clear-Workflow (Two-Root-Rule) · Last-Root-Out-of-Band-Recovery · Anti-Pattern-Liste |
