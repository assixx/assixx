...
| **Version Drift**     | npm `11.9.0` vs `11.8.0`, pnpm `10.30.2` vs `10.33.1` across files                                                         | HIGH     |
...
| pnpm      | `10.30.2` (prod hardcoded), `10.33.1` (dev, frontend ARG) | `10.33.1` via ARG everywhere |
