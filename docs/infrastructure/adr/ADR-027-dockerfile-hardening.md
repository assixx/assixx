...
| **Version Drift**     | npm `11.9.0` vs `11.8.0`, pnpm `10.30.2` vs `10.31.0` across files                                                         | HIGH     |
...
| pnpm      | `10.30.2` (prod hardcoded), `10.31.0` (dev, frontend ARG) | `10.31.0` via ARG everywhere |
