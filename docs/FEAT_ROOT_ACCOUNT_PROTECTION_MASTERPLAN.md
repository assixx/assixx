...
> **Plan type:** FEATURE
> **Created:** 2026-04-26
> **Version:** 1.3.2 (Phase 5 Step 5.2 DONE — Session 9b /manage-root cross-root immutability gates)
> **Status:** Phase 1 COMPLETE 2026-04-26 — Phase 2 COMPLETE 2026-04-27 — Phase 3 COMPLETE 2026-04-28 — Phase 4 COMPLETE 2026-04-28 — Phase 5 IN PROGRESS (Steps 5.1 + 5.2 done, 5.3 pending)
> **Branch:** `feat/root-account-protection`
> **Spec:** Inline — see §Goal below
> **Author:** Simon Öztürk
> **Estimated sessions:** 10
> **Actual sessions:** 14 / 10+ (Phase 0-4 done in 12 sessions per v1.3.0; Sessions 9 + 9b close Phase 5 Steps 5.1 + 5.2; Step 5.3 split out for Session 9c per /continue's one-step-per-session discipline)
...
- [x] svelte-check 0 errors, 0 warnings (Sessions 9 + 9b: 2574 files clean)
- [x] ESLint 0 errors (Sessions 9 + 9b)
- [ ] German labels everywhere (Steps 5.1 + 5.2 in German; 5.3 pending)
...
| 9c      | 5     | Frontend: `/manage-approvals` `RootSelfTerminationCard` (Step 5.3)                                          |        |            |
