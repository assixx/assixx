...
> **Plan type:** FEATURE
> **Created:** 2026-04-26
> **Version:** 1.1.4 (Step 5.2 + design-system polish + chip-colour regression fixed — type discriminator now injected from bucket name onto each option)
> **Status:** Step 5.2 complete + design-system polish iteration applied + chip colours render correctly (svelte-check 2578/0/0, frontend ESLint clean on KVP route, root stylelint clean); Step 5.4 detail-view display is the next blocker
