...
function printResult(testName, passed, message = '') {
  ...
  console.log(`${symbol} ${color}${testName}${colors.reset}${message ? ` - ${message}` : ''}`);
}
...
async function testSystemSettingsAccess() {
  ...
  try {
    ...
    printResult('Admin denied system settings access', passed, 
  ...
  try {
    ...
    printResult('Root can access system settings', false, 
...
async function testTenantSettings() {
  ...
  try {
    ...
    printResult('Admin can view tenant settings', false, 
      `Error: ${error.response?.data?.error?.message || error.message}`);
  }
  ...
  try {
    ...
    printResult('Admin can create tenant setting', false, 
      `Error: ${error.response?.data?.error?.message || error.message}`);
  }
}
...
async function testUserSettings() {
  ...
  try {
    ...
    printResult('User can create own setting', false, 
      `Error: ${error.response?.data?.error?.message || error.message}`);
  }
}
...
async function testCategories() {
  ...
  try {
    ...
    printResult('Get categories endpoint', false, 
      `Error: ${error.response?.data?.error?.message || error.message}`);
  }
}
