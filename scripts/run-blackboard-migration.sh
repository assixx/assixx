...
echo "  mysql -u root -p main < backend/src/database/migrations/add_blackboard_attachments.sql"
echo ""
echo "Option 2 (with sudo):"
echo "  sudo mysql main < backend/src/database/migrations/add_blackboard_attachments.sql"
echo ""
echo "Option 3 (if using Docker):"
echo "  docker exec -i assixx-mysql mysql -u root -p'StrongP@ssw0rd!123' main < backend/src/database/migrations/add_blackboard_attachments.sql"
echo ""
