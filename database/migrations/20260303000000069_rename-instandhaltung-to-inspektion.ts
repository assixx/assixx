...
export function up(pgm: MigrationBuilder): void {
  ...
  pgm.sql(`ALTER TYPE tpm_card_category RENAME VALUE 'instandhaltung' TO 'inspektion';`);
...
export function down(pgm: MigrationBuilder): void {
  pgm.sql(`ALTER TYPE tpm_card_category RENAME VALUE 'inspektion' TO 'instandhaltung';`);
