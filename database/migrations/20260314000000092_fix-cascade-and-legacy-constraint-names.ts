...
const RENAMES: [string, string, string][] = [
  ...
  ['admin_permission_logs', 'admin_permission_logs_ibfk_1', 'fk_admin_perm_logs_tenant'],
  ['admin_permission_logs', 'admin_permission_logs_ibfk_3', 'fk_admin_perm_logs_changed_by'],
  ['api_keys', 'api_keys_ibfk_1', 'fk_api_keys_tenant'],
  ['api_keys', 'api_keys_ibfk_2', 'fk_api_keys_created_by'],
  ['blackboard_confirmations', 'blackboard_confirmations_ibfk_1', 'fk_bb_confirmations_entry'],
  ['blackboard_confirmations', 'blackboard_confirmations_ibfk_2', 'fk_bb_confirmations_user'],
  ['blackboard_entries', 'blackboard_entries_ibfk_1', 'fk_blackboard_entries_tenant'],
  ['calendar_attendees', 'calendar_attendees_ibfk_1', 'fk_calendar_attendees_event'],
  ['calendar_attendees', 'calendar_attendees_ibfk_2', 'fk_calendar_attendees_user'],
  ...
  ['deletion_dry_run_reports', 'deletion_dry_run_reports_ibfk_1', 'fk_deletion_reports_tenant'],
  ['deletion_dry_run_reports', 'deletion_dry_run_reports_ibfk_2', 'fk_deletion_reports_user'],
  ['deletion_partial_options', 'deletion_partial_options_ibfk_1', 'fk_deletion_options_queue'],
  ['departments', 'departments_ibfk_4', 'fk_departments_created_by'],
  ['document_permissions', 'document_permissions_ibfk_1', 'fk_doc_perm_document'],
  ['document_permissions', 'document_permissions_ibfk_2', 'fk_doc_perm_user'],
  ['document_permissions', 'document_permissions_ibfk_3', 'fk_doc_perm_department'],
  ...
  ['document_read_status', 'document_read_status_ibfk_1', 'fk_doc_read_document'],
  ...
  ['failed_file_deletions', 'failed_file_deletions_ibfk_1', 'fk_failed_file_del_queue'],
  ['failed_file_deletions', 'failed_file_deletions_ibfk_2', 'fk_failed_file_del_user'],
  ['kvp_attachments', 'kvp_attachments_ibfk_1', 'fk_kvp_attachments_suggestion'],
  ['kvp_comments', 'kvp_comments_ibfk_1', 'fk_kvp_comments_suggestion'],
  ['kvp_ratings', 'kvp_ratings_ibfk_1', 'fk_kvp_ratings_suggestion'],
  ['kvp_status_history', 'kvp_status_history_ibfk_1', 'fk_kvp_status_history_suggestion'],
  ['kvp_suggestions', 'kvp_suggestions_ibfk_1', 'fk_kvp_suggestions_tenant'],
  ['kvp_suggestions', 'kvp_suggestions_ibfk_4', 'fk_kvp_suggestions_assigned_to'],
  ...
  ['notification_preferences', 'notification_preferences_ibfk_1', 'fk_notification_prefs_user'],
  [
    'notification_read_status',
    'notification_read_status_ibfk_1',
    'fk_notification_read_notification',
  ],
  ['notification_read_status', 'notification_read_status_ibfk_2', 'fk_notification_read_user'],
  ['notification_read_status', 'notification_read_status_ibfk_3', 'fk_notification_read_tenant'],
  ...
  ['password_reset_tokens', 'password_reset_tokens_ibfk_1', 'fk_password_reset_user'],
  ['payment_history', 'payment_history_ibfk_1', 'fk_payment_history_tenant'],
  ['payment_history', 'payment_history_ibfk_2', 'fk_payment_history_subscription'],
  ['shift_assignments', 'shift_assignments_ibfk_1', 'fk_shift_assignments_shift'],
  ['shift_assignments', 'shift_assignments_ibfk_2', 'fk_shift_assignments_user'],
  ['shift_assignments', 'shift_assignments_ibfk_3', 'fk_shift_assignments_assigned_by'],
  ...
  ['shift_swap_requests', 'shift_swap_requests_ibfk_1', 'fk_shift_swap_assignment'],
  ['shift_swap_requests', 'shift_swap_requests_ibfk_2', 'fk_shift_swap_requested_by'],
  ['shift_swap_requests', 'shift_swap_requests_ibfk_3', 'fk_shift_swap_requested_with'],
  ['shift_swap_requests', 'shift_swap_requests_ibfk_4', 'fk_shift_swap_approved_by'],
  ...
  ['survey_assignments', 'survey_assignments_ibfk_1', 'fk_survey_assignments_survey'],
  ['survey_assignments', 'survey_assignments_ibfk_4', 'fk_survey_assignments_user'],
  ['survey_comments', 'survey_comments_ibfk_1', 'fk_survey_comments_survey'],
  ['survey_participants', 'survey_participants_ibfk_1', 'fk_survey_participants_survey'],
  ['survey_participants', 'survey_participants_ibfk_2', 'fk_survey_participants_user'],
  ...
  ['survey_templates', 'survey_templates_ibfk_2', 'fk_survey_templates_created_by'],
  ...
  ['tenant_deletion_queue', 'tenant_deletion_queue_ibfk_1', 'fk_deletion_queue_tenant'],
  ['tenant_deletion_queue', 'tenant_deletion_queue_ibfk_2', 'fk_deletion_queue_created_by'],
  ['tenant_settings', 'tenant_settings_ibfk_1', 'fk_tenant_settings_tenant'],
  ['tenant_subscriptions', 'tenant_subscriptions_ibfk_1', 'fk_tenant_subscriptions_tenant'],
