...
\restrict TakdDrpwij3EWgkMw5tTlWQfR0MnbyEB0evSAI3zKW3Za6MLbmekNP9Ubrqoelk
...
--
-- Name: public; Type: SCHEMA; Schema: -; Owner: assixx_user
--

-- *not* creating schema, since initdb creates it


ALTER SCHEMA public OWNER TO assixx_user;

--
-- Name: SCHEMA public; Type: COMMENT; Schema: -; Owner: assixx_user
--
...
--
-- Name: COLUMN conversations.is_active; Type: COMMENT; Schema: public; Owner: assixx_user
--
...
--
-- Name: COLUMN documents.message_id; Type: COMMENT; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments; Type: TABLE; Schema: public; Owner: assixx_user
--
...
ALTER TABLE public.message_attachments OWNER TO assixx_user;

--
-- Name: message_attachments_id_seq; Type: SEQUENCE; Schema: public; Owner: assixx_user
--
...
ALTER SEQUENCE public.message_attachments_id_seq OWNER TO assixx_user;

--
-- Name: message_attachments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments id; Type: DEFAULT; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments message_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments unique_message_document; Type: CONSTRAINT; Schema: public; Owner: assixx_user
--

ALTER TABLE ONLY public.message_attachments
    ADD CONSTRAINT unique_message_document UNIQUE (message_id, document_id);
...
--
-- Name: idx_conversations_uuid; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: idx_documents_conversation_id; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: idx_documents_message_id; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: idx_message_attachments_document_id; Type: INDEX; Schema: public; Owner: assixx_user
--

CREATE INDEX idx_message_attachments_document_id ON public.message_attachments USING btree (document_id);


--
-- Name: idx_message_attachments_message_id; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: idx_message_attachments_tenant_id; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: idx_root_logs_is_active; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: idx_shifts_tenant_plan_user_date; Type: INDEX; Schema: public; Owner: assixx_user
--
...
--
-- Name: documents fk_documents_conversation; Type: FK CONSTRAINT; Schema: public; Owner: assixx_user
--
...
--
-- Name: documents fk_documents_message; Type: FK CONSTRAINT; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments fk_message_attachments_document; Type: FK CONSTRAINT; Schema: public; Owner: assixx_user
--

ALTER TABLE ONLY public.message_attachments
    ADD CONSTRAINT fk_message_attachments_document FOREIGN KEY (document_id) REFERENCES public.documents(id) ON DELETE CASCADE;


--
-- Name: message_attachments fk_message_attachments_message; Type: FK CONSTRAINT; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments fk_message_attachments_tenant; Type: FK CONSTRAINT; Schema: public; Owner: assixx_user
--

ALTER TABLE ONLY public.message_attachments
    ADD CONSTRAINT fk_message_attachments_tenant FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: documents chat_participant_isolation; Type: POLICY; Schema: public; Owner: assixx_user
--
...
--
-- Name: conversations conversations_delete; Type: POLICY; Schema: public; Owner: assixx_user
--
...
--
-- Name: conversations conversations_insert; Type: POLICY; Schema: public; Owner: assixx_user
--
...
--
-- Name: conversations conversations_select; Type: POLICY; Schema: public; Owner: assixx_user
--
...
--
-- Name: conversations conversations_update; Type: POLICY; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments; Type: ROW SECURITY; Schema: public; Owner: assixx_user
--
...
--
-- Name: messages participant_isolation; Type: POLICY; Schema: public; Owner: assixx_user
--
...
--
-- Name: message_attachments tenant_isolation; Type: POLICY; Schema: public; Owner: assixx_user
--

CREATE POLICY tenant_isolation ON public.message_attachments USING (((NULLIF(current_setting('app.tenant_id'::text, true), ''::text) IS NULL) OR (tenant_id = (NULLIF(current_setting('app.tenant_id'::text, true), ''::text))::integer)));
...
--
-- Name: SCHEMA public; Type: ACL; Schema: -; Owner: assixx_user
--
...
\unrestrict TakdDrpwij3EWgkMw5tTlWQfR0MnbyEB0evSAI3zKW3Za6MLbmekNP9Ubrqoelk
