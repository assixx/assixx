...
-- Table: active_shifts_today
-- --------------------------------------------
;

-- Table: active_surveys
-- --------------------------------------------
;
...
-- Table: blackboard_confirmations
-- --------------------------------------------
  `id` int NOT NULL AUTO_INCREMENT,
  `entry_id` int NOT NULL,
  `user_id` int NOT NULL,
...
-- Table: calendar_recurring_rules
-- --------------------------------------------
  `id` int NOT NULL AUTO_INCREMENT,
  `event_id` int NOT NULL,
...
-- Table: current_employee_availability
-- --------------------------------------------
;
...
-- Table: employee_availability_old
-- --------------------------------------------
  `id` int NOT NULL AUTO_INCREMENT,
  `tenant_id` int NOT NULL,
  `user_id` int NOT NULL,
...
-- Table: employee_overview
-- --------------------------------------------
;

-- Table: employees_without_documents
-- --------------------------------------------
;
