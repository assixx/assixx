...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Physical locations/areas (e.g., buildings, halls, warehouses)';
...
) ENGINE=InnoDB AUTO_INCREMENT=302 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Stores file attachments for blackboard entries (PDFs, images)';
DELIMITER ;;
...
CREATE TABLE `calendar_attendees` (
  ...
  `user_id` int NOT NULL,
  `response_status` enum('pending','accepted','declined','tentative') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `responded_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_event_user` (`event_id`,`user_id`),
  KEY `idx_event_status` (`event_id`,`response_status`),
  KEY `idx_tenant_attendee` (`tenant_id`,`user_id`),
  KEY `idx_tenant_event` (`tenant_id`,`event_id`),
  KEY `idx_calendar_attendees_pending` (`user_id`,`response_status`,`tenant_id`),
...
CREATE TABLE `calendar_events` (
  ...
  `org_level` enum('company','department','team','personal') COLLATE utf8mb4_unicode_ci DEFAULT 'personal',
  ...
  `requires_response` tinyint(1) DEFAULT '0' COMMENT 'Whether this event requires a response from attendees',
  ...
  KEY `idx_calendar_requires_response` (`tenant_id`,`requires_response`,`status`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2737 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Organizational departments within areas';
...
) ENGINE=InnoDB AUTO_INCREMENT=1737 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Junction table: which teams work on which machines';
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Machines located in departments/areas';
...
) ENGINE=InnoDB AUTO_INCREMENT=5145 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Logs all administrative actions performed by users';
...
CREATE TABLE `shifts` (
  ...
  `type` enum('regular','overtime','standby','vacation','sick','holiday','early','late','night','day','flexible') DEFAULT 'regular',
  `notes` text,
  `department_id` int NOT NULL,
  `team_id` int DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5766 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=2050 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Teams that work in departments and operate machines';
...
) ENGINE=InnoDB AUTO_INCREMENT=1594 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=5564 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=35207 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
SET character_set_client = @saved_cs_client;
DROP TABLE IF EXISTS `v_shift_management`;
SET @saved_cs_client     = @@character_set_client;
 1 AS `id`,
 1 AS `tenant_id`,
 1 AS `date`,
